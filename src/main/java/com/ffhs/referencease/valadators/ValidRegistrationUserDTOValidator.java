...
public class ValidRegistrationUserDTOValidator implements ConstraintValidator<ValidRegistrationUserDTO, UserAccountDTO> {
  ...
  public boolean isValid(UserAccountDTO value, ConstraintValidatorContext context) {
    ...
    return (value.getEmail() != null && value.getPassword() != null && value.getConfirmPassword() != null &&value.getPassword().equals(value.getConfirmPassword()));
  }
}
